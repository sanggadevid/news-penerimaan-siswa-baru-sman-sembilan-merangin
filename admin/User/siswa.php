            ...
            <div class="box-body">
              ...
              <form method="POST" class="form-horizontal" action="" enctype="multipart/form-data">
                 <div class="row">
                  ...
                  <br>
                  <div class="col-md-2">Pilih Tahun</div>
                  <div class="col-md-3">
                  <?php
                      $now=date('Y');
                  ...
                  <div class="col-md-4">
                   ...
                   <button type="submit" name="savecari" class="btn btn-danger btn-flat">Cari</button>
                  </div>
                 </div>
                ...
                <hr>
                  ...
                  <?php if(isset($_POST['savecari'])){?>
                  <tbody>
                    <?php
                    $be = mysqli_query($con, "SELECT * FROM psb where kelulusan='1' AND thn_aprove='$_POST[tahun]' ORDER BY id_psb ASC");
                    $no = 1;
                  ...
                  <?php }else{?>
                    <tbody>
                    <?php
                    $be = mysqli_query($con, "SELECT * FROM psb where kelulusan='1' ORDER BY id_psb ASC");
                    $no = 1;
                    while ($r = mysqli_fetch_assoc($be)) {
                    ?>
